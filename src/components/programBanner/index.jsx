...
import video_bg from '../../assets/video/pro_vid.mp4'
                    ...
                    <div className={styles.main_ai}>
                        <div className={styles.sec_content}>
                            <div className={styles.motivation}>
                                <h1 style={{ fontWeight: 400 }}>Programmatic Advertising</h1>
                            </div>
                            <div className={styles.motivation}>
                                <h1 className={styles.gradientText}>Services Powered by</h1>
                            </div>

                            <div className={styles.motivation}>
                                <h1><span style={{ color: "#6751d6" }}>AI</span>Attribution</h1>
                            </div>
                        </div>

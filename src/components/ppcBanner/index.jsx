...
import video_bg from '../../assets/video/paid.mp4'
                    ...
                    <div className={styles.main_ai}>
                        <div className={styles.sec_content}>
                            <div className={styles.motivation}>
                                <h1 style={{ fontWeight: 400 }}>Paid Search</h1>
                            </div>
                            <div className={styles.motivation}>
                                <h1 className={styles.gradientText}>Advertising</h1>
                            </div>

                            <div className={styles.motivation}>
                                <h1><span style={{ color: "#6751d6" }}>That</span>Delivers Real ROI</h1>
                            </div>
                        </div>
